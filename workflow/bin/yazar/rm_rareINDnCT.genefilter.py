...
def count_expressed(x, threshold):
    x = x.unstack()
...
def main():
    ...
    gene_prop_threshold = float(snakemake.wildcards.gene_prop)
    ...
    selected = ctp.apply(count_expressed, threshold=gene_prop_threshold)
